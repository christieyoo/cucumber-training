...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $olderPosts(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('div', null, null, 'class', 'container');
      var childPageList56 = opt_data.site.index.children[0].children;
      var childPageListLen56 = childPageList56.length;
      for (var childPageIndex56 = 0; childPageIndex56 < childPageListLen56; childPageIndex56++) {
        var childPageData56 = childPageList56[childPageIndex56];
        if (opt_data.page.url != childPageData56.url) {
          ie_open('div', null, null, 'class', 'post-item container-blog');
          ie_open('a', null, null, 'class', 'post-item__link', 'href', childPageData56.url);
          ie_open('small');
          itext('By ');
          var dyn5 = childPageData56.author;
          if (typeof dyn5 == 'function') dyn5();else if (dyn5 != null) itext(dyn5);
          itext(' ');
          ie_open('span');
          itext('| ');
          var dyn6 = childPageData56.date;
          if (typeof dyn6 == 'function') dyn6();else if (dyn6 != null) itext(dyn6);
          ie_close('span');
          ie_close('small');
          ie_open('h4', null, null, 'class', 'post-item__title');
          var dyn7 = childPageData56.title;
          if (typeof dyn7 == 'function') dyn7();else if (dyn7 != null) itext(dyn7);
          ie_close('h4');
          ie_close('a');
          ie_close('div');
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param143 = function param143() {
        ...
        itext('cucumber --init');
        ie_close('code');
        itext(' from this directory.  Examine the default folder structure and files that were created.');
        ie_close('li');
        ie_open('li');
        ...
        ie_open('ul');
        ie_open('li');
        itext('Add the following to env.rb (in cucumber-practice/features/support)');
        ie_close('li');
        ie_close('ul');
